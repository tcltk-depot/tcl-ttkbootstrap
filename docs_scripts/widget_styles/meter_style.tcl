# Meter Styles — shows all color and style variants
package require Tk
lappend auto_path [file join [file dirname [info script]] ../..] 
package require ttkbootstrap
ttkbootstrap::Window -themename litera -title "Meter Styles"
...
foreach color $colors {
    ...
    ttkbootstrap::Meter $p.m_$color \
        -metersize 150 -amountused 75 \
        -subtext $color -bootstyle $color -interactive 1
    pack $p.m_$color -side left -padx 3 -pady 5
}
